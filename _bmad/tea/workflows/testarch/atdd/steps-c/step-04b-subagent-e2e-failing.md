...
- Proactively use the Playwright MCP to navigate the live application, inspect the DOM structure, and verify locators in real-time. This ensures that generated selectors are highly resilient, accurate, and tied to the actual rendered application rather than assumptions.
