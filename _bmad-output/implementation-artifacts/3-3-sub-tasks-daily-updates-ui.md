...
| `src/test/story-3-3-subtask-edit-reorder.test.tsx` | Created | 30 tests for sub-task inline edit + drag reorder/delete |
| `src/test/story-3-3-daily-update-gating.test.tsx` | Created | 18 tests for daily update 24h gating + error toasts |
